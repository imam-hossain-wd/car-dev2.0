...
import { Wrench, Droplet, Fan, Battery, Settings, CheckCircle2 } from "lucide-react";

export function FeaturedServices() {
  const services = [
    {
      title: "Car AC Repair",
      description: "Professional AC diagnosis and repair to keep you cool in Dubai's heat",
      icon: <Fan className="h-8 w-8 text-blue-500" />,
      image: "https://www.24carservicedubai.com/_next/image?url=https%3A%2F%2Fi.ibb.co%2F3M1rWfR%2Fcar-bettery-repair-replace.pnghttps%3A%2F%2Fi.ibb.co%2FD4qgrX2%2Fcar-bettery-repair-replace.webp&w=640&q=75",
    ...
    },
    {
      ...
      features: ["Fault code reading", "Performance tuning", "Full system scan"]
    },
    {
      title: "Brake Service",
      description: "Complete brake inspection and repair",
